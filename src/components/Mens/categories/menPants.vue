 ...
 <div id="home">
   <div class="container"><br>
    ...
    <div class="col-4 col-md-4"><h3 class="lin"><router-link  active-class="active"   to="/cart" exact>
                 <button type="button" id="cart"  class="btn  btn-lg">CART</button>
                  </router-link></h3></div>
    <div class="col-4 col-md-4"><h3 class="h3">PANTS</h3></div>
  </div>
   </div>
   ...
   <div class="container">
    <div class="row">
       ...
       <div class="col-xs-12 col-sm-6" v-for="(item,index) in items" :key="index">
         <div class="card box">
                <div class="row ">
